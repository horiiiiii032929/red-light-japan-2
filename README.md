...
Ideally we recommend running a local copy of your database so that schema updates are as fast as possible. By default the Postgres adapter has `push: true` for development environments. This will lZet you add, modify and remove fields and collections without needing to run any data migrations.
